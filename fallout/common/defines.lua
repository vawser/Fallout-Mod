...
NGame = {
	START_DATE = "2280.1.1",
	END_DATE = "3000.1.1",
	MAX_RANDOM_NEW_WORLD = "3000.1.1",

	GREAT_POWER_FRENZY_START = "3000.1.1",	-- Latest date for the start of the Great Power Frenzy (struggle).
...
NDiplomacy = {
	...
	IMPERIAL_AUTHORITY_FROM_PRINCES = 0.0,			-- Scales to threshold
	HRE_FOREIGN_CONTROL_PENALTY = 0.0,			-- Each foreign-controlled province in the empire (owned or vassalised) lowers IA by this amount
	HRE_HERETIC_PENALTY = 0.0,					-- Per heretic prince (halved by Peace of Westphalia)
	LACK_OF_ELECTORS_HIT = 0.0,					-- Also applied to vassalized electors
	IMPERIAL_REFORM_COST = 100,						-- Minium Cost of enacting a new reform.
...
NCountry = {
	...
	ABDICATE_LEGITIMACY_THRESHOLD = 100,
	ABDICATE_AGE_THRESHOLD = 18,
	ABDICATE_RULING_LENGTH_THRESHOLD = 0,
	ABDICATE_LEGITIMACY_HIT = -80,
	ABDICATE_PRESTIGE_HIT = -80,
	...
	ALLOW_ESTATE_AND_PARLIAMENT_SEAT_IN_PROVINCE = 1, -- Whether or not a province can have both an estate and a parliament seat
	...
	ESTATE_HAPPY_THRESHOLD = 70,
	ESTATE_LOYALTY_DECAY_BASE_MIN = 0.5,		-- Loyalty change per year at middle level.
	ESTATE_LOYALTY_DECAY_BASE_MAX = 1.0,		-- Loyalty change per year at most extreme levels.
	ESTATE_INFLUENCE_LEVEL_1 = 30,
	ESTATE_INFLUENCE_LEVEL_2 = 50,
	ESTATE_INFLUENCE_LEVEL_3 = 70,
	...
	ESTATE_PROVINCE_HAPPINESS_CHANGE_MAX_POS = 25,	-- Loyalty cannot change more than this from a single province add
	ESTATE_PROVINCE_HAPPINESS_CHANGE_MAX_NEG = 25,	-- Loyalty cannot change more than this from a single province revoke
	...
	CULTURAL_UNION_MIN_DEV = 9999999,				-- Minimum development to get cultural union effect without Common Sense, or if CULTURAL_UNION_MIN_RANK is set to negative value.
	CULTURAL_UNION_MIN_RANK = -1,		
	ESTATE_GRANT_PROVINCE_COOLDOWN = 1,			-- A province cannot be revoked for this amount of years after being granted to an estate
		-- Minimum rank to get cultural union effect with Common Sense.
	...
	FEMALE_ADVISOR_CHANCE = 0,						-- If Women in History is enabled, chance of an advisor (or general if permitted) spawning as female
	...
	CIRCUMNAVIGATION_PROVINCE_1 = 1516,			-- Provinces for circumnavigation (coast of gambia)
	CIRCUMNAVIGATION_PROVINCE_2 = 1530,			-- Provinces for circumnavigation (magellan strait)
	CIRCUMNAVIGATION_PROVINCE_3 = 1554,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_4 = 1667,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_5 = 1690,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_6 = 1716,			-- Provinces for circumnavigation (cape of good hope)
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.0,			-- yearly increase in price in percent,
	...
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 120.0,		-- Promote advisor cost in monthly salaries
	...
	LEGITIMACY_DYNASTY_CHANGE = 50,					-- Legitimacy a new dynasty starts out with
	...
	STRENGTHEN_GOVERNMENT_REPUBLICAN_TRADITION = 10,
	...
	STARTING_ARMY_SIZE = 0.25,						-- Percentage of force limit
	...
	MIGRATION_BOOST = 10,							-- How many points given when migrating.
	MIGRATION_COOLDOWN = 12,						-- How many months until next migration is possible.
	MIGRATION_DEPLETION_TIME = 365,				    -- How many days a province needs to recover from migrants
	...
	MAX_CROWN_COLONIES = 99999,							-- How many province a country can hold in a colonial region before creating a colonial nation
	...
	RAZE_TECH_POWER_DECREASE = 0.01, -- Per military tech above base level
...
NEconomy = {
	...
	GOLD_INFLATION = 0.25,							-- _EDEF_GOLD_INFLATION_
...
NMilitary = {
	...
	HEAVY_SHIP_SAILORS_COST = 100,					-- 1 = 1 men in cost.
	LIGHT_SHIP_SAILORS_COST = 50,					-- 1 = 1 men in cost.
	GALLEY_SHIP_SAILORS_COST = 75,					-- 1 = 1 men in cost.
	...
	ARTILLERY_COST = 50.0, 							-- _MDEF_ARTILLERY_COST = 10,
	FORTRESS_COST = 0.1,							-- base fort cost
	...
	TRADITION_GAIN_LAND = 50,						-- Tradition gain base value from land combat.
	...
	DEFAULT_WARGOAL_WARSCORE_BONUS	= 20,			-- Warscore bonus
	...
	FORT_FLIPPING_TIME = 365,					-- Number of days it takes an influencing fort to revert the control of a province if left unhindered.
	...
	SUPPLY_DEPOT_MIL_COST = 25,						-- Mil power cost to build a supply depot in an area.
	...
	NAVAL_DOCTRINE_MIN_FORCE_LIMIT = 99999,			-- Minimum naval force limit to be able to select a naval doctrine
	...
	FLAGSHIP_REQUIRED_NAVY_SIZE_IN_SAILORS = 1000,	-- The number of sailors employed in the navy required to unlock the flagship
	FLAGSHIP_COST_DUCATS = 100,						-- The cost in ducats of a flagship
	FLAGSHIP_COST_SAILORS = 250,					-- The cost in sailors of a flagship
...
NAI = {
	...
	DEVELOP_IN_SUBJECTS_PREFERENCE = 0.25, -- At 1, AI likes developing subjects approximately the same as its own provinces (more or less depending on their Liberty Desire).
	...
	AGGRESSIVENESS_BONUS_EASY_WAR = 3000, -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	MAX_SAVINGS = 120, -- AI will keep a maximum of this * their monthly income in long-term savings
	...
	DEVELOPMENT_CAP_BASE = 300,	-- AI will not develop provinces that have more development than this or DEVELOPMENT_CAP_MULT*original development (whichever is bigger)
	...
	PEACE_TIME_MAX_MONTHS = 120, -- Max months applied to time factor in a war
	...
	PEACE_DESPERATION_FACTOR = 80, -- AI willingness to peace based on desperation from occupied homelands
	...
	MISSIONARY_MAINTENANCE_SHARE = 0.3,							-- The most an AI will spend of its income on a missionary
},
...
NReligion = {
	...
	CONSECRATE_PATRIARCH_THRESHOLD = 25, --in development
	ORTHODOX_ICON_DURATION_MONTHS = 240,
	ORTHODOX_ICON_AUTHORITY_COST = 0.2,
	...
	MIN_CARDINALS = 0,											-- Least amount of cardinals/ Starting cardinals
	MAX_CARDINALS = 0,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 0,								-- Max cardinals in a single country
	...
	NUMBER_OF_POSSIBLE_CARDINALS = 0,							-- Number of cardinals from said number of most successful provinces to be randomly picked from.
...
NNationDesigner = {
	...
	MANDATE_SUBCONTINENT_NAME = "west_coast_superregion", -- Name of the subcontinent where the Mandate will be given to the biggest nation by development when using random generated nations
},
...
NGovernment = {
	...
	RUSSIAN_ABILITY_OPRICHNINA_CHANGE = -0.5,
	RUSSIAN_ABILITY_STRELTSY_WE_CHANGE = -5,
	...
	TRAIN_HORSEMANSHIP_DURATION_YEARS = 5,
	...
	GOVERNMENT_REFORM_HISTORIC_AUTONOMY = 0.0,
	GOVERNMENT_REFORM_CHANGE_CORRUPTION = 2.0,
	...
	LEGACY_NATIVES_REFORM_MONARCHY_SPONSOR = "settlement_legacy",
