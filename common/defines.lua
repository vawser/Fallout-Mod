...
NDiplomacy = {
	...
	AE_INFIDEL_CONQUEST = 0.0, 		-- different religion group conquered same religion province
	AE_SAME_RELIGION = 0.0,
	AE_SAME_RELIGION_GROUP = 0.0,
	AE_DIFFERENT_RELIGION = 0.0,
	AE_HRE_INTERNAL = 1.0,
	AE_ATTACKER_DEVELOPMENT = 0.03,	-- +50% cap (at 1000 development)
...
NCountry = {
	...
	GREAT_PROJECT_MANPOWER_REQUIRED_FOR_CONSTRUCTION_BOOST = 3000, --use a bunch of manpower to move things on
...
NMilitary = {
	...
	ARMY_ATTRITION_AT_COAST = 0,					-- How many percent attrition units take while loaded onto ships along the coast
	ARMY_ATTRITION_AT_SEA = 0,						-- How many percent attrition units take while loaded onto ships traveling open sea
...
NAI = {
	...
	ARTILLERY_FRACTION = 0.35, 	-- Ratio of artillery to infantry AI will build (doubles after FORCE_COMPOSITION_CHANGE_TECH_LEVEL) (reduced when on tight budget)
